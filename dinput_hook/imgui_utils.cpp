...
static DebugPanel g_panel_hud_mode = {
    ...
    .keywords = "hud heads up display speedometer dial gauge cycle hide minimal",
...
static DebugPanel g_panel_game = {
    ...
    .keywords = "game settings difficulty language subtitles units gameplay",
...
static DebugPanel g_panel_collision = {
    ...
    .keywords = "collision mesh trigger volume hitbox wireframe overlay opacity",
...
static DebugPanel g_panel_mods = {
    .category = "Debug", .name = "Mods",
    .keywords = "mod registry enable disable module journal patch owner version",
    .draw = panel_mods, .dev_only = true};
