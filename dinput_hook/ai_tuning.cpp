...
// Registered in main.cpp; owns the AI full-LOD .text patches through the mod journal, so the
// toggle has to go through set_mod_enabled rather than writing the patches directly.
