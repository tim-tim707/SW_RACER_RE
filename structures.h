...
typedef struct
{
    // is it really position ?
    float[3] position; // +0x50 = X position float
    // +0x54 = Y position float
    // +0x58 = Z position float
    // +0x60 flags
    // & 0x20 = if playcam
    ...
    // | 0x40 = set Mirror
    //  & 0x400 = MagnetMode (what does it do ?)
    ...
    float[3] some_vec; // +0x16c, anti-grav offset to ground ?
    // +0x170
    // +0x174
    float speed; // +0x1a0
    ...
    // +0x1bc Y
    // +0x1c0 Z
    float[3] some_vec2; // 0x1c4 set to zero on tunnel exit
    // 0x1c8
    // 0x1cc
    ...
    // +2c0 damage warning timer
    float totalDamage; // +2c4
} Player;
