...
set SOURCES=src\dllMain.c src\main.c src\hook.c src\swr.c src\hook_generated.c src\stdPlatform.c src\Dss\*.c src\Engine\*.c src\General\*.c src\Gui\*.c src\Main\*.c src\Platform\*.c src\Primitives\*.c src\Raster\*.c src\Unknown\*.c src\Swr\*.c src\Win95\*.c
