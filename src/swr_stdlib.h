...
int stdlib___isctype(int c, _ctype_t desc);
...
intptr_t stdlib___findfirst(const char* filespec, struct _finddata_t* fileinfo);
int stdlib___findnext(intptr_t handle, struct _finddata_t* fileinfo);
...
void __cdecl stdlib___lock(int locknum);
void __cdecl stdlib___unlock(int locknum);
