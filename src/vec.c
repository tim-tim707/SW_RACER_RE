...
float *__cdecl sub_4323C0(float *a1, const float *a2)
{
    ...
    // Get squared length
    float v19 = a2[0 * 4 + 0] * a2[0 * 4 + 0] + a2[0 * 4 + 1] * a2[0 * 4 + 1]
        + a2[0 * 4 + 2] * a2[0 * 4 + 2];
    double v3 = a2[1 * 4 + 0] * a2[1 * 4 + 0] + a2[1 * 4 + 1] * a2[1 * 4 + 1]
        + a2[1 * 4 + 2] * a2[1 * 4 + 2];
    float v16 = a2[2 * 4 + 0] * a2[2 * 4 + 0] + a2[2 * 4 + 1] * a2[2 * 4 + 1]
        + a2[2 * 4 + 2] * a2[2 * 4 + 2];
    ...
    a1[3 * 4 + 0] =
        -(v17 * a1[1 * 4 + 0] + v12 * a1[2 * 4 + 0] + a1[0 * 4 + 0] * v20);
