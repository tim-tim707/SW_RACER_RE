int __cdecl sub_429DC0(int a1, char *a2, int a3, int a4, int a5)
{
    ...
    *(_DWORD *)a4 = -10000;
    ...
    {
    case 0:
        v6 = lookup_translation(
            *(const char **)(*(_DWORD *)(*(_DWORD *)(v5 + 7792) + 24) + 24));
        v7 = lookup_translation(
            *(const char **)(*(_DWORD *)(*(_DWORD *)(v5 + 7792) + 24) + 20));
...
v6 = lookup_translation(*(
    const char **)(*(_DWORD *)(*(_DWORD *)(v5 + 7792) + 24) + 24)); // prename?
v7 = lookup_translation(*(
    const char **)(*(_DWORD *)(*(_DWORD *)(v5 + 7792) + 24) + 20)); // lastname?
sprintf(a2, aNameSS, v7, v6);
struct
{
    uint8_t unk[108];
...
ObjectHeader *__cdecl sub_450AA0(uint32_t a1, int a2)
{
    ...
    while (1)
    {
        // Lookup object list, if there is none, we can abort as we don't have a
        // list to search
        ObjectList *v3 = *v2++;
        if (!v3)
        {
        ...
        {
            ObjectHeader *r =
                (uintptr_t)v3->first_element + i * v3->element_size;
