...
// scratch block stores 10 mesh pointers per control point, indexed by segmentT * 10). Cached into
// player->splineTrackMesh and promoted to player->terrainModel while the ground cache is valid.
